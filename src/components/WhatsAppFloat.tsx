...
export default function WhatsAppFloat() {
  ...
  // URL principal de la comunidad WhatsApp
  const whatsappCommunity =
    process.env.NEXT_PUBLIC_WHATSAPP_COMMUNITY ||
    'https://chat.whatsapp.com/ItxIlzImaWN1SBGpAZSdrg';

  // Asegurar que el componente está montado antes de renderizar
  useEffect(() => {
    setIsMounted(true);
  }, []);

  // No renderizar hasta que esté montado (previene errores de hidratación)
  if (!isMounted) {
    return null;
  }
