export default function EscapeRoomPage() {
  // Canal específico de WhatsApp para Escape Room
  const whatsappEscapeRoom =
    process.env.NEXT_PUBLIC_WHATSAPP_ESCAPE_ROOM ||
    'https://chat.whatsapp.com/DW3ZtOG85meKywPaF4Cokn';

  return (
    <>
      <section className="nerd-hero" aria-labelledby="escape-room-title">
        <div className="nerd-kicker">Entretenimiento nerd</div>
        <h1 id="escape-room-title" className="nerd-title">
          Escape Room 🔐
        </h1>
